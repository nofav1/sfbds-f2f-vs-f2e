"""python -m sfbds_compare.analysis --input-dir results/study --out-dir results/analysis"""
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    parser.add_argument("--out-dir", required=True, help="Directory for analysis artifacts")
