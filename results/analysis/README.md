...
| [`2026-08-14-maze255-braid-and-128-md48`](2026-08-14-maze255-braid-and-128-md48/) | 2026-08-14 | maze 127/255 ± braid; nested 128@45–50% md 28 vs md 48 | Size×braid interaction and 45–50% nested random at the original Manhattan 48 (fewer connected queries). **Density tests in this README pool md-28 with md-48; use the next row.** |
| [`2026-08-14-density-by-experiment`](2026-08-14-density-by-experiment/) | 2026-08-14 | same experiments as the previous row | Re-analysis after density tests were keyed by experiment (stats-code fix; old snapshot kept). |
