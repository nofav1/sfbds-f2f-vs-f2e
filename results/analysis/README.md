...
| [`pair-bound/2026-08-17-heuristic-strength`](pair-bound/2026-08-17-heuristic-strength/) | 2026-08-17 | replay of six `*_opt` families (F2F+F2E only) | **Mechanism.** Same `(u,v,g)` under both LBs. Partially explains maze/open/braid expansion pattern. Nested 30% vs 45% are different seeds. |
