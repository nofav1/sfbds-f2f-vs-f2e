...
```bash
python -m sfbds_compare.analysis --input-dir results/study/pair-bound --out-dir results/analysis/pair-bound/2026-08-17-cost-clean-tests
```
...
- **Random (all files):** 180 solved pairs; 6 F2F-fewer, 0 F2E-fewer, 54 ties (n_test=60). Wilcoxon is skipped on this pooled group; use nested density rows below.
- **Nested density:** no obstacle_count group had 10+ untied pairs, so Wilcoxon p-values are null; win counts and median saving % still apply.
- **Overall nested random:** 180 maps from 60 families (median expansion_diff per family). Untied=6. Do not cite a pooled p here; use the per-experiment density table.

Coverage of this run: **270** paired instances, **270** solved, **0** timed out, **180** nested-density rows, map families corridor, maze, open, random. Cost mismatches (F2F / F2E / A* when A* succeeded): **12**.
...
- **`cost_mismatch`** = F2F, F2E, or successful A* disagree on solution cost. Those rows stay in `paired.csv` but are **excluded from expansion tests** (Wilcoxon, sign, F2F-fewer / F2E-fewer / ties, expansion saving %).
...
| maze | 30 | 30 | 22 | 0 | 8 | 3.4% | 4.77e-07 | 1.00 | F2F fewer expansions; p=4.77e-07 |
| open | 30 | 30 | 0 | 0 | 30 | 0.0% | null | — | p null (too few untied pairs) |
| random | 180 | 60 | 6 | 0 | 54 | 0.0% | null | — | tests skipped (see note) |
...
| group | n_solved | n_test | F2F fewer | F2E fewer | ties | median saving % | p (Holm if planned) | rank-biserial | read as |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| study_random_128: 1638 obstacles (~0.10 on 128×128) | 30 | 29 | 0 | 0 | 29 | 0.0% | null | — | p null (too few untied pairs) |
| study_random_128: 3276 obstacles (~0.20 on 128×128) | 30 | 28 | 0 | 0 | 28 | 0.0% | null | — | p null (too few untied pairs) |
| study_random_128: 4915 obstacles (~0.30 on 128×128) | 30 | 27 | 4 | 0 | 23 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| study_random_64: 1228 obstacles (~0.30 on 64×64) | 30 | 26 | 9 | 0 | 17 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| study_random_64: 409 obstacles (~0.10 on 64×64) | 30 | 30 | 0 | 0 | 30 | 0.0% | null | — | p null (too few untied pairs) |
| study_random_64: 819 obstacles (~0.20 on 64×64) | 30 | 28 | 4 | 0 | 24 | 0.0% | null | 1.00 | p null (too few untied pairs) |

### Overall nested random (one median per family)

| group | n_solved | n_test | F2F fewer | F2E fewer | ties | median saving % | p (Holm if planned) | rank-biserial | read as |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nested random families | 180 | 60 | 6 | 0 | 54 | 0.0% | null | — | tests skipped (see note) |

## Size

| group | n_solved | n_test | F2F fewer | F2E fewer | ties | median saving % | p (Holm if planned) | rank-biserial | read as |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 127 | 30 | 30 | 22 | 0 | 8 | 3.4% | 4.77e-07 | 1.00 | F2F fewer expansions; p=4.77e-07 |
| 128 | 120 | 60 | 2 | 0 | 58 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| 512 | 30 | 30 | 0 | 0 | 30 | 0.0% | null | — | p null (too few untied pairs) |
| 64 | 90 | 30 | 4 | 0 | 26 | 0.0% | null | 1.00 | p null (too few untied pairs) |
...
- F2F faster wall-clock: **16**; F2E faster: **6**; equal: **0**
- Median runtime_ratio: **0.896**; mean: **0.972**
...
| group | n_solved | n_test | F2F fewer | F2E fewer | ties | median saving % | p (Holm if planned) | rank-biserial | read as |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [1, 1.1) | 197 | 119 | 3 | 0 | 116 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| [1.1, 1.5) | 39 | 30 | 7 | 0 | 23 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| [1.5, 2) | 4 | 3 | 2 | 0 | 1 | 13.4% | null | 1.00 | p null (too few untied pairs) |
| [2, inf) | 30 | 30 | 22 | 0 | 8 | 3.4% | 4.77e-07 | 1.00 | F2F fewer expansions; p=4.77e-07 |
