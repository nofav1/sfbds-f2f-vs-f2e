...
```bash
python -m sfbds_compare.analysis --input-dir results/study/pair-bound --out-dir results/analysis/pair-bound/2026-08-17-baseline-study
```
...
- **Nested density tests with n_untied ≥ 10:** obstacle_count {study_random_64: 1228 obstacles (~0.30 on 64×64)}. Other density levels had too many ties for a p-value.
...
Coverage of this run: **270** paired instances, **270** solved, **0** timed out, **180** nested-density rows, map families corridor, maze, open, random. Cost mismatches (F2F vs F2E solution cost): **12**.
...
| group | n_solved | n_test | F2F fewer | F2E fewer | ties | median saving % | p (Holm if planned) | rank-biserial | read as |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| study_random_128: 1638 obstacles (~0.10 on 128×128) | 30 | 30 | 1 | 0 | 29 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| study_random_128: 3276 obstacles (~0.20 on 128×128) | 30 | 30 | 2 | 0 | 28 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| study_random_128: 4915 obstacles (~0.30 on 128×128) | 30 | 30 | 7 | 0 | 23 | 0.0% | null | 1.00 | p null (too few untied pairs) |
| study_random_64: 1228 obstacles (~0.30 on 64×64) | 30 | 30 | 13 | 0 | 17 | 0.0% | 0.0002 | 1.00 | F2F fewer expansions; p=0.0002 |
| study_random_64: 409 obstacles (~0.10 on 64×64) | 30 | 30 | 0 | 0 | 30 | 0.0% | null | — | p null (too few untied pairs) |
| study_random_64: 819 obstacles (~0.20 on 64×64) | 30 | 30 | 6 | 0 | 24 | 0.0% | null | 1.00 | p null (too few untied pairs) |
...
| [1.5, 2) | 4 | 4 | 3 | 0 | 1 | 22.0% | null | 1.00 | p null (too few untied pairs) |
